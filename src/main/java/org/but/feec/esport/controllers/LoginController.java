...
public class LoginController {
    ...
    private void initializeLogos() {
        Image lolImage = new Image(App.class.getResourceAsStream("/org.but.feec.esport/logos/logo.png"));
        ImageView lolLogoImage = new ImageView(lolImage);
        lolLogoImage.setFitHeight(135);
        lolLogoImage.setFitWidth(500);
        lolLogoImage.setPreserveRatio(true);
        lolLogo.setGraphic(lolLogoImage);
    }
